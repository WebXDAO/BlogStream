...
export default function Footer() {
  return (
    <footer className='bg-white py-10 px-5 md:p-20' aria-labelledby='footer-heading'>
      <div>
        <div className='grid grid-cols-3 gap-2'>
          ...
          <div className='lg:mt-12 grid grid-cols-3 gap-2 col-span-3 lg:col-span-2'>
            ...
            <div className='col-span-3 md:col-span-1 md:gap-4'>
              <div className='mt-6 md:mt-0'>
                ...
                <ul role='list' className='mt-4 space-y-4'>
                  <li>
                    <a href='#' className='flex text-base  hover:text-gray-900'>
                      <svg
                        className='h-6 w-6 '
                        fill='currentColor'
                        viewBox='0 0 24 24'
