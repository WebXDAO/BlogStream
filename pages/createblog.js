...
function CreateBlog() {
  ...
  return !isAuthenticated ? (
    ...
    <Layout>
      <div className='px-4'>
        <div className='my-2 border-2 border-dashed w-fit mx-auto p-5 rounded-lg'>
          <label className='text-2xl' htmlFor='image'>
            {fileUrl ? 'Image Added' : 'Choose an Image'}
          </label>
          <input className='hidden' onChange={onChange} id='image' type='file' />
        </div>
        <div class='mb-4 flex justify-center items-center space-x-4 mx-8'>
