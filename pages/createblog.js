...
function CreateBlog() {
  ...
  return (
    <>
      <Head>
        <title>Write Blog | BlogStream</title>
      </Head>
      {!isAuthenticated ? (
        ...
        <Layout>
          <div className='px-4'>
            ...
            <div className='mb-4 flex w-full justify-center items-center space-x-2'>
              ...
              <input
                className='shadow appearance-none border rounded w-1/3 py-4 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline'
                id='flowrate'
                type='number'
                min={0.0001}
                step={0.0001}
